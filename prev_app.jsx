...
function App() {
  // EmailJS formul├írio de contato
  const [formData, setFormData] = useState({
    from_name: "",
    to_name: "Jo├úo Vitor Oliveira",
    email: "",
    subject: "",
    message: "",
    reply_to: "",
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          setIsLoading(false);
          setErrorMsg(
            "N├úo foi poss├¡vel enviar. Tente novamente ou use outro canal."
          );
        }
      );
  };
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "P├ígina personalizada com links para redes sociais, projetos e contatos. Design moderno com anima├º├Áes e estat├¡sticas din├ómicas.",
      image: "/linkinbio.png",
    ...
    },
    {
      ...
      description:
        "Plataforma completa de e-commerce com frontend React e backend Node.js. Sistema de autentica├º├úo, carrinho de compras e integra├º├úo com banco de dados.",
      image: "/banner1.png",
    ...
    },
    {
      ...
      description:
        "Aplicativo de mem├│rias compartilhadas para casais com funcionalidades de upload de fotos, timeline e notifica├º├Áes.",
    ...
    {
      title: "ZapBot-Cobran├ºa",
      description:
        "Rob├┤ de cobran├ºa automatizada para WhatsApp com integra├º├úo de APIs e sistema de agendamento.",
      image: "/zapbot.png",
    ...
    },
    {
      ...
      description:
        "Rob├┤ de postagem automatizada de v├¡deos para TikTok com sistema de agendamento e an├ílise de performance.",
    ...
    },
    {
      ...
      description:
        "Aplicativo para gera├º├úo de recibos para pequenos neg├│cios com templates personaliz├íveis e exporta├º├úo em PDF.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    ...
    },
    {
      ...
      description:
        "Plataforma b├ísica para compra e venda de NFTs com integra├º├úo de carteira digital e contratos inteligentes.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Plataforma para encontrar e agendar hor├írios com barbeiros locais, com avalia├º├Áes e fotos de cortes anteriores.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    ...
    {
      title: "Remunera├º├úo em casa",
      description:
        "Sistema para papais e mam├úes gerenciarem a mesada dos filhos, com metas de economia e recompensas com servi├ºos dom├®sticos.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "E-commerce de roupas tem├íticas para desenvolvedores, com designs exclusivos e integra├º├úo com redes sociais.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "E-commerce de moda feminina com cat├ílogo diversificado, sistema de recomenda├º├Áes e checkout simplificado.",
      image: "/ella.png",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Plataforma que usa varios marketplaces para vender e reunir produtos de diferentes lojas, com sistema de compara├º├úo de pre├ºos.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Aplicativo desktop simples desenvolvido com Electron, demonstrando integra├º├úo com APIs e funcionalidades b├ísicas.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "API robusta para processamento de pagamentos online, com suporte a m├║ltiplos gateways e seguran├ºa avan├ºada. gerar qr code e ate manipular e ter controle total das opera├º├Áes.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Blog otimizado para SEO com integra├º├úo de an├║ncios do Google AdSense e gera├º├úo de conte├║do automatizada por IA.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    ...
    {
      title: "Sistema para servi├ºos automotivos",
      description:
        "Plataforma para agendamento e gerenciamento de servi├ºos automotivos, com hist├│rico de manuten├º├úo e lembretes.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Sistema de atendimento automatizado via WhatsApp com integra├º├úo de IA para respostas inteligentes com agendamento e pedidos de servi├ºos.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    ...
    },
    {
      ...
      description:
        "Sistema de gerenciamento de frequ├¬ncia para aulas de karat├¬, com controle de presen├ºa e relat├│rios de desempenho.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Processando informa├º├Áes de sa├║de e bem-estar dos pets, com recomenda├º├Áes personalizadas e agendamento de consultas.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Sistema de gerenciamento de projetos de engenharia com IA para otimiza├º├úo de recursos e cronogramas.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Sistema de an├ílise de desempenho esportivo com IA, com apostas e estat├¡sticas em tempo real.",
      image: "/bannerdev.jpg",
      tech: [],
      github: "#",
      demo: "#",
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-foreground">
                  Prazer, me chamo Jo├úo! ­ƒæ¿­ƒÅ¢ÔÇì­ƒÆ╗
                </h3>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Com anos de viv├¬ncia em tecnologias, sou apaixonado por criar
                  solu├º├Áes que fazem a diferen├ºa. Minha jornada come├ºou com
                  curiosidade pela tecnologia e se transformou em uma carreira
                  dedicada ├á excel├¬ncia no desenvolvimento de software.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div
                  ...
                  tabIndex={0}
                  aria-label="Resolu├º├úo de Problemas"
                >
                  <Smartphone
                ...
                <div
                  ...
                  tabIndex={0}
                  aria-label="Inova├º├úo Constante"
                >
                  <Globe
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-foreground group-hover:text-yellow-500 transition-colors">
                          ­ƒÅå Top 10 Melhores Alunos - Full Stack
                        </h4>
                        <p className="text-sm text-muted-foreground mt-1">
                          Gera├º├úo Tech ÔÇó Dez 2024
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-foreground group-hover:text-accent transition-colors">
                          O-HACKA-TA-ON 3┬¬ Edi├º├úo
                        </h4>
                        <p className="text-sm text-muted-foreground mt-1">
                          UNIFOR + M. Dias Branco ÔÇó Jun 2025
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-foreground group-hover:text-pink-500 transition-colors">
                          Introdu├º├úo a UX/UI Design
                        </h4>
                        <p className="text-sm text-muted-foreground mt-1">
                          CITINOVA ÔÇó Mai 2025
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <section id="projects" className="py-20 relative px-2 sm:px-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto bree-serif-regular">
              Solu├º├Áes que criei para resolver problemas reais
            </p>
          </div>
            ...
            {isSent ? (
              <div className="card-cyberpunk p-8 sm:p-12 text-center">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Obrigado pelo contato! Em breve voc├¬ receber├í uma resposta. ­ƒÿè
                </p>
              ...
              <div className="card-cyberpunk p-6 sm:p-8">
                <div className="mb-6 sm:mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Preencha o formul├írio abaixo e eu retornarei o mais breve
                    poss├¡vel.
                  </p>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-primary mb-1">
                          Privacidade e Seguran├ºa
                        </p>
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          Seus dados s├úo tratados com total confidencialidade e
                          n├úo ser├úo compartilhados com terceiros. Utilizo essas
                          informa├º├Áes apenas para contato profissional e
                          resposta ├ás suas solicita├º├Áes.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <footer className="py-8 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-muted-foreground">
            <p>
              &copy; 2025 Jo├úo Vitor Oliveira. Todos os direitos reservados.
            </p>
            <p className="mt-2">Desenvolvido com ­ƒÆ£ e muito Ôÿò</p>
          </div>
        </div>
      </footer>
    </div>
